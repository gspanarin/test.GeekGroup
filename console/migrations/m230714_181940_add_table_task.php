...
class m230714_181940_add_table_task extends Migration{
    ...
    public function safeUp() {
        ...
        $this->createTable('{{%task}}', [
            ...
            'user_id' => $this->integer()->notNull()->comment('Користувач, відповідальний за задачу'),
            ...
            'start_date' => $this->integer()->defaultValue(null)->comment('Дата початку роботи над задачею'),
            'finish_date' => $this->integer()->defaultValue(null)->comment('Дата завершення роботи над задачею'),
