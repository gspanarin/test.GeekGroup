        ...
        <?php Pjax::end(); ?>
          ...
          <li class="bg-white mb-3">
            <div class="form-outline">
              <?php $form = ActiveForm::begin(['id' => 'sendCommentForm','action' => '/admin/comment/ajax-create?user_id=' . Yii::$app->user->id . '&project_id=' . $model->project_id . '&task_id=' . $model->id]); ?>
                <textarea name="Comment[text]" class="form-control" id="comment-text" rows="4"></textarea>
              <label class="form-label" for="comment-text">Message</label>
              <?php ActiveForm::end(); ?>
            </div>
          </li>
...
$script = 
    ...
    'var pjax_url = "/admin/comment/index-task-comment?user_id=' . Yii::$app->user->id . '&project_id=' . $model->project_id . '&task_id=' . $model->id . '";' . 
    <<< JS
